...
public final class RopeRenderer {
    public void draw(GraphicsContext g, List<RopeNode> nodes, Charm charm) {
        ...
        g.setEffect(null);g.setLineWidth(3.35);g.setStroke(material);stroke(g,nodes);
        g.setLineWidth(.72);g.setStroke(Color.color(t.ropeHighlight().getRed(),t.ropeHighlight().getGreen(),t.ropeHighlight().getBlue(),.65));stroke(g,nodes);
